...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">SocialPeoples: <b>{{$socialPeopleAll->name}}</b></div>
    ...
    <div class="panel-body">
        ...
        <table class="table table-bordered table-responsive">
            ...
            @foreach ($socialPeopleAll->getAttributes() as $attribute => $value)
                <tr>
                    <td>{{$attribute}}</td>
                    <td>{{$value}}</td>
                </tr>
