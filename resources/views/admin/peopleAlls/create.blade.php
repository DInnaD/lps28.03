...
@section('panel')
    <div class="panel-heading container-fluid">
        ...
        <a class="btn btn-info btn-xs col-md-1 col-sm-2 col-xs-2" href="{{ route('peopleAlls.index', compact('portfolio','page')) }}">
    ...
    <div class="panel-body">
          ...
          {!! Form::open(['route' => ['peopleAlls.store', 'portfolio' => $portfolio, 'page' => $page], 'method'=> 'POST', 'enctype' => 'multipart/form-data', 'file'=>true]) !!}                     
