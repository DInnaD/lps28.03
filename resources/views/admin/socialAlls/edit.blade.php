...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            ...
            <div class="centered-child col-md-9 col-sm-7 col-xs-6">Edit Social: <b>{{$socialAll->name}}</b></div>
    ...
    <div class="panel-body">
        {!! Form::model($socialAll, ['route' => ['socialAlls.update', $socialAll->id], 'method' => 'PUT']) !!}
        @include('admin.socialAlls._form')
        @include('admin.socialAlls._edit_form')
